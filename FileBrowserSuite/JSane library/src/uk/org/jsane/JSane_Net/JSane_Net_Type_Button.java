 ...
 * @author Andi McLean
 */
public class JSane_Net_Type_Button extends JSane_Base_Type_Button implements
	JSane_Net_Transport
{
	public JSane_Net_Type_Button()
	{
		super();
	}

	public JSane_Net_Type_Button( JSane_Wire wire )
	{
		super();
		_getElement( wire );
	}
	...
	{
		return new JSane_Net_Type_Button( wire );
	}

	public void _sendElement( JSane_Wire wire )
	{
		// We do not send this type.
	}
